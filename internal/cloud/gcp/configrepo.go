...
type ConfigRepository interface {
	...
	FindByDiscoveryID(discoveryJobID primitive.ObjectID) ([]cloud.ResourceConfig, error)
	// FindByID(id primitive.ObjectID) (*DiscoveryJob, error)
...
func (r *configRepository) FindByDiscoveryID(discoveryJobID primitive.ObjectID) ([]cloud.ResourceConfig, error) {
